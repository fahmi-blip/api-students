...
// LoadPermissions mengambil SELURUH pasangan role-permission sekaligus.
// LEFT JOIN dipakai sengaja: role tanpa permission (mis. "user") tetap
// harus muncul, supaya IsKnownRole tetap true untuknya.
