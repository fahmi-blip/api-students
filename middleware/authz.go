...
// RequirePermission menolak request yang role-nya tidak memiliki permission
// tertentu. Dipasang pada route yang haknya dapat diputuskan TANPA melihat
// isi data (mis. "boleh melihat daftar seluruh student").
